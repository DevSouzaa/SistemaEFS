...
begin
  ...
  try
    ...
    Permissao.AcaoId := 1; // ID da Ação "Cliente"
    ...
    Permissao := TAcesso.Create;
    Permissao.PerfilId := FUsuario.PerfilId;
    Permissao.AcaoId := 2; // ID da Ação "Produto"
    ...
    Permissao := TAcesso.Create;
    Permissao.PerfilId := FUsuario.PerfilId;
    Permissao.AcaoId := 3; // ID da Ação "Usuario"
