...
begin
     ...
     fnc_CriarMensagem('Erro de Autenticação', 'Usuário Não Encontrado',
        'Usuário não encontrado. Verifique o login informado.', ExtractFilePath(Application.ExeName) + '\Icones\Atencao.png', 'OK');
